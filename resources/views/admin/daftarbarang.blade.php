<x-admin-layout>
    ...
    <button class="px-4 py-1 text-sm rounded text-green-600 font-semibold border border-green200 hover:text-white hover:bg-green-600 hover:border-transparent focus:outlinenone">Update</button>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        ...
        <tr>
         ...
         <div class="ml-4">
            ...
            <a href="{{route('barang.edit',$item->package_id)}}" class="text-indigo600 hover:text-indigo-900">Edit</a>
            <form action="{{route('barang.destroy',$item->package_id)}}" method="POST">
